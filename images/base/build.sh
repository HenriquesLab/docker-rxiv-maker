...
echo ""
print_info "Usage with standalone Docker execution:"
echo "  docker run --rm -v \$(pwd):/workspace $IMAGE_NAME rxiv pdf"
echo "  docker run --rm -v \$(pwd):/workspace $IMAGE_NAME rxiv validate"
echo "  docker run --rm -v \$(pwd):/workspace $IMAGE_NAME rxiv test"
echo ""
